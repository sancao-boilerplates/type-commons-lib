...
class GenericCrudService extends service_1.HttpService {
    ...
    setAuthHeader() {
        var _a;
        if (auth_decorator_1.AuthSession.getToken()) {
            const config = this.getRequestConfig();
            config.headers = (_a = config.headers) !== null && _a !== void 0 ? _a : {};
            config.headers['Authorization'] = auth_decorator_1.AuthSession.getToken();
            this.setRequestConfig(config);
            node_smart_log_1.Logger.info('Token added to request header');
        }
    }
    create(t) {
