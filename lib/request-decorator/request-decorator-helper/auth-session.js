...
class AuthSession {
     ...
     */
    static getEmail() {
        return cls_1.StorageContext.getContextValue('loggedUserEmail', cls_1.ClsContextNamespace.AUTH);
    }
    /**
     ...
     */
    static getId() {
        return cls_1.StorageContext.getContextValue('loggedUserId', cls_1.ClsContextNamespace.AUTH);
    }
}
