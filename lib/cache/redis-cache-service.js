...
var RedisCache = /** @class */ (function () {
    ...
    RedisCache.generateCacheKey = function (app, key) {
        return CryptoJS.SHA1("".concat(app, "_").concat(key)).toString();
    };
    RedisCache.getClient = function () {
        if (RedisCache.redisInstance && RedisCache.redisInstance.client) {
            return RedisCache.redisInstance;
        }
        var credentials = JSON.parse("".concat(constants_1.AppConstants.CACHE.REDIS_CONNECTION));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        redisIntance = RedisCache.getClient();
                        return [4 /*yield*/, redisIntance.setCacheAsync(cachekey, parseInt("".concat(RedisCache.cacheTime), 10), JSON.stringify(obj))];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, obj];
                    case 3:
