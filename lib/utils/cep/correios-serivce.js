...
var cep_type_1 = require("./cep-type");
var CorreiosService = /** @class */ (function (_super) {
    ...
    CorreiosService.prototype.getFromCorreios = function (cep) {
        return __awaiter(this, void 0, void 0, function () {
            var correiosUrl, body, responseString, response, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        correiosUrl = 'SigepMasterJPA/AtendeClienteService/AtendeCliente';
                        body = this.getCorreiosRequestBory(cep);
                        return [4 /*yield*/, this.post(correiosUrl, body)];
                    case 1:
                        responseString = _a.sent();
                        return [4 /*yield*/, this.parseResponse(responseString)];
                    case 2:
                        response = _a.sent();
    ...
    CorreiosService.prototype.parseResponse = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, xml_to_json_1.XmlToJsonUtil.xmlToJson(response, 'return')];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, {
                                cep: result.cep,
    ...
    CorreiosService.prototype.getCorreiosRequestBory = function (cep) {
