    ...
    getAddressFromGoogle(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                node_smart_log_1.Logger.error(`Error while getting address (${address}) from google `, err);
                throw err;
            }
        });
    }
    getAddressFromGeoLocation(lat, lng) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                node_smart_log_1.Logger.error(`Error while getting geolocation (${lat},${lng}) from google `, error);
                throw error;
            }
        });
    }
