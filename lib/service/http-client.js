...
var HttpClient = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        log_1.Logger.error("Error executing http request method:" + method + " to: " + config.baseURL + "/" + config.url, err_1.message);
    ...
    HttpClient.prototype.generateRequestConfig = function (method, url, payload, requestConfig) {
        ...
        var correlationId = log_1.LoggerContext.getCorrelationId() || uuid_1.v4();
        ...
        var config = __assign(__assign({}, requestConfig), { method: method,
